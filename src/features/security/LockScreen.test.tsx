 ...
 *
 * Covers the spec'd copy: the title is always `PadDy` (never `App Locked`), it
 * is NOT followed by an "Unlock to continue" subtitle, and the mode-specific
 * instructions (`Draw your pattern` / `Enter your PIN`) plus the pattern hint
 * render inside the matching area.
 */
describe('LockScreen', () => {
